// ====== СЛОВА (ваш список) ======
const VOCAB = [
  { en: "plug", ru: "штекер; подключать (вставлять штекер)", pron: "плаг" },
  { en: "to plug in", ru: "подключить (к розетке/порту)", pron: "ту плаг ин" },
  { en: "snapshot", ru: "снимок; снимок состояния (в ИТ)", pron: "снэпшот" },
  { en: "take a system snapshot", ru: "сделать снимок системы", pron: "тэйк э систэм снэпшот" },
  { en: "defines", ru: "определяет; задаёт", pron: "дифайнз" },
  { en: "displays", ru: "отображает; показывает", pron: "дисплэйз" },
  { en: "exploring", ru: "исследуя; изучение", pron: "иксплоринг" },
  { en: "to explore", ru: "исследовать; изучать", pron: "ту иксплор" },
  { en: "executes", ru: "выполняет (исполняет)", pron: "эксикьютс" },
  { en: "flow", ru: "поток; ход/последовательность выполнения", pron: "флоу" },
  { en: "last", ru: "последний; прошлый", pron: "ласт" },
  { en: "determined", ru: "определённый; установленный", pron: "дитёрминд" },
  { en: "included", ru: "включённый", pron: "инклудид" },
  { en: "to include", ru: "включать; содержать", pron: "ту инклуд" },
  { en: "search", ru: "поиск; искать", pron: "сёрч" },
  { en: "inbuilt", ru: "встроенный", pron: "инбилт" },
  { en: "existing", ru: "существующий; имеющийся", pron: "игзистинг" },
  { en: "wiring", ru: "проводка; соединение проводами", pron: "уайэринг" },
  { en: "wire", ru: "провод", pron: "уайэр" },
  { en: "to wire", ru: "подключать/соединять проводами", pron: "ту уайэр" },
  { en: "purpose", ru: "цель; назначение", pron: "пёрпас" }
];
...
function buildScore() {
  ...
  const maxScore = n * 20; // 10 (matching) + 5 (mcq) + 5 (typing) за слово (если всё пройти по одному разу)
  let points = 0;
